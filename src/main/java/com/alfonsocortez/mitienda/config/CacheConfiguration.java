package com.alfonsocortez.mitienda.config;
...
public class CacheConfiguration {
    ...
    public HazelcastInstance hazelcastInstance(JHipsterProperties jHipsterProperties) {
        ...
        HazelcastInstance hazelCastInstance = Hazelcast.getHazelcastInstanceByName("tiendavirtual");
        if (hazelCastInstance != null) {
            log.debug("Hazelcast already initialized");
            return hazelCastInstance;
        }
        Config config = new Config();
        config.setInstanceName("tiendavirtual");
        ...
        config.getMapConfigs().put("com.alfonsocortez.mitienda.domain.*", initializeDomainMapConfig(jHipsterProperties));
